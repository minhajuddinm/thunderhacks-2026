...
// Sponsor tiers - Platinum, Gold, Food, Silver
const sponsors = {
  platinum: [
    {
      id: 1,
  ...
  silver: [
    {
      ...
      name: "StartupHub",
      logo: "/placeholder-logo.svg",
      description: "Tech startup incubator",
      website: "https://example.com",
    },
    {
      id: 5,
...
const tierShadows = {
  ...
  silver: "hover:shadow-gray-400/20",
}
                ...
                >
                  <Card className={`bg-card border-2 ${tierBorders.platinum} transition-all hover:shadow-xl ${tierShadows.platinum}`}>
                    <CardContent className="p-10 flex flex-col items-center text-center">
                      <div className="w-40 h-40 bg-muted rounded-xl flex items-center justify-center mb-6">
                ...
                >
                  <Card className={`bg-card border-2 ${tierBorders.gold} transition-all hover:shadow-lg ${tierShadows.gold}`}>
                    <CardContent className="p-8 flex flex-col items-center text-center">
                      <div className="w-36 h-36 bg-muted rounded-lg flex items-center justify-center mb-4">
                        <span className="text-5xl font-bold text-muted-foreground">
                          {sponsor.name.charAt(0)}
                        </span>
                      </div>
            ...
            <div className="grid sm:grid-cols-2 md:grid-cols-4 gap-4 max-w-5xl mx-auto">
              {sponsors.silver.map((sponsor) => (
                <a
                  ...
                  className="block"
                >
                  <Card className={`bg-card border ${tierBorders.silver} transition-all hover:shadow-md ${tierShadows.silver}`}>
